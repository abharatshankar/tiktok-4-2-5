...
class profileSearchVC: BottomPopupViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate{
...
//
    ...
    var tab1VC:usersVC! = nil
    var tab2VC:songsPageVc! = nil
    var tab3VC:hashTagsVC! = nil
    ...
    private func createPageViewController() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            self.pageController.view.frame = CGRect(x: 0, y: 70  /** 0.3*/, width: self.view.frame.size.width, height: self.view.frame.size.height - self.view.frame.size.height  * 0.3)
        }
        
        let homeStoryboard = UIStoryboard(name: "Main", bundle: nil)
        tab1VC = homeStoryboard.instantiateViewController(withIdentifier: "usersVC") as! usersVC
        tab2VC = homeStoryboard.instantiateViewController(withIdentifier: "songsPageVc") as! songsPageVc
        tab3VC = homeStoryboard.instantiateViewController(withIdentifier: "hashTagsVC") as! hashTagsVC
